    ...
    <section className="bg-gray-900 text-gray-100 min-h-screen py-20">
      <div className="max-w-6xl mx-auto px-6 space-y-16">
        ...
        <motion.div
          ...
          className="bg-gray-800/60 backdrop-blur-lg rounded-2xl shadow-lg p-8 space-y-6 text-center"
        >
          ...
          >
            ...
            <p className="text-gray-300">
              ...
              <span className="font-semibold text-white">
                elegant design, blazing-fast performance, and intuitive features
              </span>. Whether you are a developer or a user, we aim to make tech work beautifully for you.
            </p>
          </motion.div>
        ...
        <div className="text-center space-y-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { title: "Innovation", color: "text-blue-400", desc: "We push boundaries with modern tools and fresh ideas." },
              { title: "Trust", color: "text-green-400", desc: "Security and reliability are at the core of everything we build." },
              { title: "Collaboration", color: "text-pink-400", desc: "We believe the best results come when we work together." },
            ].map((val, idx) => (
              <motion.div
                key={idx}
              ...
              >
                <h3 className={`text-xl font-semibold ${val.color} mb-2`}>{val.title}</h3>
