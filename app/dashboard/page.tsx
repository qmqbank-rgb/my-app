  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-xl transition transform hover:-translate-y-1">
      ...
      <div className="p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg">
        ...
        <ResponsiveContainer width="100%" height={250}>
          <LineChart data={transactionData}>
            ...
            <YAxis />
            <Tooltip />
            <Line type="monotone" dataKey="amount" stroke="#34D399" strokeWidth={3} />
          </LineChart>
        </ResponsiveContainer>
      </div>

      {/* Recent Transactions Table */}
      <div className="p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-x-auto">
          ...
          <tbody>
            {recentTransactions.map((txn) => (
              ...
              >
                ...
                <td
                  className={`p-2 font-semibold rounded-full w-max px-2 ${
